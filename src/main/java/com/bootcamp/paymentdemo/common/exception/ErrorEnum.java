...
public enum ErrorEnum {
    ...
    ERR_ALREADY_CANCELLED_SUBSCRIPTION(HttpStatus.BAD_REQUEST, MSG_ALREADY_CANCELLED_SUBSCRIPTION),
    ERR_NOT_FOUND_ACTION(HttpStatus.NOT_FOUND, MSG_NOT_FOUND_ACTION),
    ERR_INVALID_BILLING_KEY(HttpStatus.BAD_REQUEST, MSG_INVALID_BILLING_KEY),
    ERR_ALREADY_SUBSCRIBED(HttpStatus.CONFLICT, MSG_ALREADY_SUBSCRIBED),
    ERR_ALREADY_PAID_THIS_PERIOD(HttpStatus.CONFLICT, MSG_ALREADY_PAID_THIS_PERIOD);
    // endregion
