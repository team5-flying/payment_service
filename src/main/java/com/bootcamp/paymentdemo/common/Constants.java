...
public class Constants {
    ...
    public static final String MSG_ALREADY_HAVE_PAYMENT = "이미 주문에 대한 결제 건이 있습니다";
    // endregion
    ...
    public static final String MSG_ALREADY_CONFIRM = "이미 주문 확정된 건입니다, 환불할 수 없습니다";
    ...
    public static final String MSG_ALREADY_SUBSCRIBED = "이미 해당 플랜을 구독 중입니다";
    public static final String MSG_ALREADY_PAID_THIS_PERIOD = "이미 이번 주기에 대한 결제가 완료되었습니다";
    // endregion
}
